...
var modals = function modals() {
  ...
  var bindModal = function bindModal(btnSelector, modalSelector, closeSelector) {
...
function tabs(linksSelecor, tabsSelector, activeClass) {
  var activeSelector = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
  var display = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  var tabLinks = document.querySelectorAll(linksSelecor),
  ...
  var showTab = function showTab() {
    ...
    if (activeSelector) {
      tabLinks.forEach(function (item) {
        return item.querySelector(activeSelector).classList.remove(activeClass);
      });
